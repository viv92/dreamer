...
class Dreamer(nn.Module):
    ...
    def train(self, explore_std):
        ...
        for tau in range(self.imagination_horizon):
            ...
            im_state_values_actor.append( self.critic_V(im_curr_state, im_curr_belief) )
        ...
        loss_critic = F.mse_loss(im_state_values_critic, critic_target)
...
if __name__ == '__main__':
    ...
    lr_critic = 8e-5
    lr_model = 6e-4
    sample_seq_len = 16 # 64 # 50 # length of contiguous sequence sampled from replay buffer (when training)
    ...
    df = 0.99
    batch_size = 256 # 64 # 50
    num_episodes = 200 # 1000
    train_episode = 1 # 25
    random_seed = 1010
    render_final_episodes = True
    init_random_episodes = 256 # 64 # 5
    ...
    hyperparam_dict['algo'] = 'dreamer6_10_noXploreImag_fixTerminalReward_maxEntropy'
    ...
    hyperparam_dict['n_episodes'] = str(num_episodes)
