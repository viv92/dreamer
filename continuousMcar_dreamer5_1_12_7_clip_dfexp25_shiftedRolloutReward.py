...
class Dreamer(nn.Module):
    ...
    def train(self):
        ...
        rewards = torch.stack(rewards[1:-1], dim=0) # [1 : H-2]
...
if __name__ == '__main__':
    ...
    for ep in tqdm(range(num_episodes)):
        ...
        while not done:
            # if render_final_episodes and ( (ep % 3 == 0) or (ep > (num_episodes - 5)) ):
...
hyperparam_dict['algo'] = 'dreamer5_dfexp25_shiftedRolloutReward'
