...
class Dreamer(nn.Module):
    ...
    def train(self):
        ...
        #     imged_states.append(im_next_state)
        #     imged_beliefs.append(im_next_belief)
        #     # for next step in rollout
        #     im_curr_state = im_next_state
        #     im_curr_belief = im_next_belief
        #
        # imged_states = torch.stack(imged_states, dim=0)
        ...
        imged_beliefs, imged_states, imged_prior_means, imged_prior_std_devs = imagination_traj
...
hyperparam_dict['algo'] = 'dreamer5_dfexp19_ablation3_2'
