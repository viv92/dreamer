...
if __name__ == '__main__':
    ...
    for ep in range(init_random_episodes):
        ...
        while not done:
            ...
            if done:
                if ep_steps == env._max_episode_steps - 1: # to differentiate between timeout termination and premature termination
                    # timeout termination
                    _done = 0
                else:
                ...
                oar_tuple = [obs, action, reward, _done]
                ...
                # add non-terminal experience to replay buffer
        ...
        while not done:
            ...
            if done:
                if ep_steps == env._max_episode_steps - 1: # to differentiate between timeout termination and premature termination
                    ...
                    _done = 1
                # add experience to replay buffer
                oar_tuple = [observation, action_numpy, reward, _done]
                agent.replay_buffer.add(oar_tuple)
                # add terminal transition to the replay buffer
...
hyperparam_dict['algo'] = 'dreamer5_1_12_7_clip_dfexp10'
