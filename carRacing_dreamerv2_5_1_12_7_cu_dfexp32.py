### Program implementing DreamerV2 on CarRacing-v1  environment
...
# Stochastic net representing parameterized gaussian distribution - used for reward model
...
if __name__ == '__main__':
    ...
    # load environment
    env = gym.make("CarRacing-v0", domain_randomize=False)
...
# hyperparam dict
hyperparam_dict = {}
hyperparam_dict['env'] = 'CarRacing-v1'
