### Program implementing Dreamer on MountainCarContinuous-v0environment
...
if __name__ == '__main__':
    ...
    explore_std_schedule = np.zeros(num_episodes)
    explore_std_schedule[:int(num_episodes * 0.8)] = np.linspace(explore_std_init, 0., int(num_episodes * 0.8))
...
hyperparam_dict['algo'] = 'dreamer5_1_12_7_softplus_dfexp4'
