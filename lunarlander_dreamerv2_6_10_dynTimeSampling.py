...
if __name__ == '__main__':
    ...
    rho = 0.25 # 0.25 # 0.75 #.95 # used for weighing actor dynamics loss and actor reinforce loss
    ...
    hyperparam_dict['algo'] = 'dreamerV2_6_10_terminalRewardFix_dynTimeSamp'
            ...
            if done:
                ...
                while len(ep_trace) < (max_time_steps + 1):
                    ...
                    if done == 1: # terminated
                        terminal_reward = reward_normalized * 0
                    else:
                        terminal_reward = reward_normalized * 0
