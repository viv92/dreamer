        ...
        while not done:
            ...
            if done:
                if ep_steps == env._max_episode_steps - 1:
                    # timeout termination
                    reset_done = 1 # set to one to reset state for first observation of next episode
                    learn_done = 0 # learning signal for df model - set to 0 for first state of next episode
                    ...
                    learn_done = 1 # set to 1 since next state is the explicit terminal state
...
hyperparam_dict['algo'] = 'dreamerV2_5_1_12_7_cu_dfexp25_maxClip:20_'
