...
# Stochastic net base for reward model - with learnable sigma
...
# Stochastic net base for observation model - with fixed sigma
...
hyperparam_dict['algo'] = 'dreamer5_dfexp25_separateNet'
