...
class RSSM(nn.Module):
    def __init__(self, in_dim, o_dim, belief_dim, h_dim, out_dim, batch_size, device):
        ...
        # self.obs_encoder_fc3 = nn.Linear(h_dim, h_dim)
        self.p_fc0 = nn.Linear(belief_dim + o_dim, h_dim)
    ...
    def forward(self, prev_belief, x, o=None):
        ...
        if o is None:
            ...
            # o = self.elu(self.obs_encoder_fc2(o))
            # o = self.obs_encoder_fc3(o)
...
hyperparam_dict['algo'] = 'dreamer5_dfexp25_UnshiftedRollout_NoObsEncoder_maxClip:20__'
