...
if __name__ == '__main__':
    ...
    o_dim = o_dim + 1 # since we concat ep_time_steps to observation
    ...
    # seed episodes
    seed_pt = 0
    while not seed_pt: # continue seed episodes until we get a premature termination
        obs = env.reset()
        done = False
        ep_steps = 0
        ...
        while not done:
            ...
            oar_tuple = [obs_cat_epsteps, action, reward, done]
    ...
    for ep in tqdm(range(num_episodes)):
        ...
        while not done:
            ...
            obs_input = torch.FloatTensor(obs_cat_epsteps).unsqueeze(0)
            ...
            # add  experience to replay buffer
            oar_tuple = [obs_cat_epsteps, action_numpy, reward, done]
...
hyperparam_dict['algo'] = 'dreamer5_dfexp26_HalfDetached'
