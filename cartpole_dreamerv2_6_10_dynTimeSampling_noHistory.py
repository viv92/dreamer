...
if __name__ == '__main__':
    ...
    imagination_horizon = 8 # 15 # length of imagined rollouts using the learnt dynamics model (when behaviour learning)
    ...
    rho = 0.25 # 0.75 # 0.5 #.95 # used for weighing actor dynamics loss and actor reinforce loss
    eta = 1e-3 # used for weighing entropy regulaization in actor loss
    df = 0.995
    batch_size = 32 # 1024 # 256
    replay_buffer_size = 10**3
    num_episodes = 500 # 200
    random_seed = 1010
    record_episode = num_episodes // 5
    init_random_episodes = 5 # 64
    num_train_calls = 10 # 30
    train_episode = 1
    action_repeat = 2
    explore_minLimit = 0. # 0.1
    max_time_steps = 500
    min_reward = -1 # 0
    max_reward = 0 # 1
    ...
    hyperparam_dict['algo'] = 'dreamerV2_6_10_df1_StateFix_noHistory_SB_NormRew'
