...
class Dreamer(nn.Module):
    ...
    def train(self):
        ...
        for tau in range(self.imagination_horizon):
            ...
            # rollout step
            rssm_input = torch.cat((im_curr_state.clone().detach(), im_curr_action), dim=1)
            im_next_state, im_next_belief = self.rssm.sample(im_curr_belief.clone().detach(), rssm_input)
...
hyperparam_dict['algo'] = 'dreamer5_1_12_7_clip_dfexp11_detached'
