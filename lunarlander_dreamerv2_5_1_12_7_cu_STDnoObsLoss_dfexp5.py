...
class DreamerV2(nn.Module):
    ...
    def train(self):
        ...
        for t in range(self.seq_len-1):
            ...
            # log prob q(r_t | s_t)
            lp_reward = self.reward_model.log_prob(curr_state, prev_reward)  # no need to skip reward loss when curr state is first state of new episode (taken care by the explicitly added terminal state)
...
if __name__ == '__main__':
    ...
    rho = 0.05 #.95 # used for weighing actor dynamics loss and actor reinforce loss
...
hyperparam_dict['algo'] = 'dreamerV2_5_1_12_7_cu_STDnoObsLoss_dfexp5'
